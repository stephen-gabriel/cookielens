...
export const WSS_URL = process.env.NEXT_PUBLIC_WSS_URL ?? "wss://wss.cookiescan.io";
export const DAS_URL = process.env.NEXT_PUBLIC_DAS_URL ?? "https://api.cookiescan.io";
...
export const COOK_PRICE_PROVIDER = {
  coingeckoId: process.env.NEXT_PUBLIC_COOK_COINGECKO_ID ?? "cookie-2",
};
